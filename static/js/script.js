...
function ageInDays() {
    var birthYear = prompt('Enter your Birth year My Friend...');
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    botDiv.innerHTML = "<img src='" + imgDatabase[botImageChoice] + "' height=150 width=150 style='box-shadow: 0px 10px 50px rgba(243, 38, 224, 1);'>"
